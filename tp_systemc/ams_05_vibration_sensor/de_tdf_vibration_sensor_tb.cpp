...
#include "de_tdf_sensor_frontend.h"
...
int sc_main(int argc, char* argv[]) {
  ...
  de_tdf_sensor_frontend<NBitsADC> frontend("frontend", dt_adc,
  ...
  // Tracing
  sca_trace_file *tfp = sca_create_tabular_trace_file("de_tdf_vibration_sensor_tb");
