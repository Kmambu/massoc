...
/*
      if (ins_rt != 0) {
      		data = RDATA >> (8 * (adr & 0x3));
         	GPR[ins_rt] = ((data & 0x00000080)
                             ? (data | 0xFFFFFF00)
                             : (data & 0x000000FF)); } 
*/
	CPU_ACCESS=DTYPE_RW;
...
/*
      if (ins_rt != 0){
         	data = RDATA >> (8 * (adr & 0x2));
         	GPR[ins_rt] = ((data & 0x00008000)
                             ? (data | 0xFFFF0000)
                             : (data & 0x0000FFFF)); } 
*/
	CPU_ACCESS=DTYPE_RW;
