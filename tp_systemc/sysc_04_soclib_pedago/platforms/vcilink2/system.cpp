...
int sc_main (int argc, char *argv[])
{
  ...
  // TME exercise: fill-in the mapping table properties.
  // Refer to soclib/include/shared/soclib_mapping_table.h file.
  SOCLIB_MAPPING_TABLE  maptab ( /* ... */ );

  // TME exercise: fill-in the information for the memory segments.
  maptab.addSegment( /* ... */ );
  ...
  ADVANCED_VCI_SIGNALS <VCI_PARAM> link_t ("link_t");
