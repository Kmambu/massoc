...
int sc_main(int argc, char* argv[]) {
  ...
  rf_front_end_eln<NBITS> rffe_1("rffe_1", Ts, inmin, inmax, Dq, Rrf, phirf, fc, H0);
  rffe_1.rf_in(rf_sig);
  ...
  sca_trace_file *tfp_rf = sca_create_tabular_trace_file("03_rf_front_end_rf_eln_tb_rf");
  ...
  sca_trace_file *tfp_bb = sca_create_tabular_trace_file("03_rf_front_end_rf_eln_tb_bb");
  sca_trace(tfp_bb, dig_sig, "dig_sig");

  // Tracing to VCD file.
  sca_util::sca_trace_file* tfp_vcd = sca_util::sca_create_vcd_trace_file("03_rf_front_end_rf_eln_tb");
