...
//
// This is an LSF implementation of the PI controller. How this is
// supposed to behave, when it is executed as part of a connected
// DTDF cluster? To profit of simulation gains due to less calculated
// solution points with DTDF, it needs to be executed as part of the
// surrounding DTDF cluster. How it can then limit the size of the
// solution step (set_max_timestep()).
...
// TODO LSF models seems not to work under DTDF conditions...
SC_MODULE(pi_ctrl)
{
