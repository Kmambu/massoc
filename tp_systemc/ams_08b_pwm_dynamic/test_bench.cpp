...
#ifndef USE_LSF_FOR_PI_CTRL
  sca_util::sca_trace_file* tfp_tab = sca_util::sca_create_tabular_trace_file("pwm_dynamic");
#else
  sca_util::sca_trace_file* tfp_tab = sca_util::sca_create_tabular_trace_file("pwm_dynamic_lsf");
#endif
...
#ifndef USE_LSF_FOR_PI_CTRL
  sca_util::sca_trace_file* tfp_vcd = sca_util::sca_create_vcd_trace_file("pwm_dynamic");
#else
  sca_util::sca_trace_file* tfp_vcd = sca_util::sca_create_vcd_trace_file("pwm_dynamic_lsf");
#endif
